...
- **What you keep:** at the end of the install you have a working ØØT instance with a Brain GitHub repo (yours), a signing key (yours), the Curator integration wired (yours), and a written install summary. Nothing the agent did is locked behind the framework's authors — everything is in your accounts and your filesystem.

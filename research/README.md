...
- [`2026-07-oot-research-article-2-fight-for-intelligence.md`](articles/2026-07-oot-research-article-2-fight-for-intelligence.md) — *The Fight for Intelligence: Putting the Organisation of Tomorrow to Work — Use Cases, Vendor Independence, and the Brain Behind the Framework*, by Dr. Tali Režun (2026-07-08). **ØØT Research Series — Article 2 (Use Cases & Vendor Independence).** Moves from thesis to practice: the fight for intelligence (grounded in the 19-day June 2026 Fable/Mythos export-control outage), the three deployment tracks (cloud / privacy / community, per ADR-003), four places leaders feel the framework immediately (speed, X-ray visibility, EU AI Act monitoring, the finance layer), and the Second Brain / Firm Brain / Ledger separation (ADR-002). Doubles as a link hub into the framework's user guides and the Curator's Shared Brain docs.
